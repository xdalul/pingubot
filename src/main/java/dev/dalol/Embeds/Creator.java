...
public class Creator extends ListenerAdapter {
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        if (event.getMessage().getContentStripped().equals("!creator")) {
            ...
            builder.addField("<:icon_outage:1093224000437637252> Kleine Information", "> Wir werden __niemals__ die Streaming plattform __Kick__ unterstützen, wir möchten nicht dass Creator von uns hier, irgendwelche __Slots Streams__ machen was ja wie ihr wisst zur Sucht kommen kann was auch schlimm enden kann.", false);
